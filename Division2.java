...
public class principal {
	...
	public static void main(String[] args) {
		...
		//while(continuar!=0){
			...
			System.out.println("Despues los dividiremos el uno por el otro y comprobaremos si la division es exacta o no, recuerda que no se puede dividir por 0.");
			System.out.println();
			...
			if(num2==0) {
				System.out.println("Recuerda que no es posible dividir por 0, Intentalo de nuevo.");
			}
			else {
				num3=num1/num2;
				if(num1%num2==0) {
