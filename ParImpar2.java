...
public class principal {
	...
	public static void main(String[] args) {
		...
		//while(continuar!=0){
			...
			if (num1%2!=0) {
				System.out.println("El numero introducido no es par, vuelva a intentarlo por favor.");
			}
			else {
				...
				if (num2%2==0) {
				System.out.println("El numero introducido no es impar, vuelva a intentarlo por favor.");	
				}
				else {
