	...
	public static void main(String[] args) {
		...
		//while(continuar!=0){
			...
			if (num1%2==0 && num2%2!=0) {
				System.out.println("Los numeros están correctos, gracias por su colaboración.");
			}
			else {
				System.out.println("Uno o los dos numeros introducidos están incorrectos, por favor intentelo de nuevo.");
			}
