...
public class principal {
	...
	public static void main(String[] args) {
		...
		int contador=0;//Contador para el bucle for
		for(contador=0; contador<decimales.length; contador++) {//Bucle que recorrera todo el array
			resultado=resultado+decimales[contador];//Operacion de suma de cada valor en cada posicion.
		}
