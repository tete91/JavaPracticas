	...
	public static void main(String[] args) {
		...
		//while(continuar!=0){
			...
			try{
				...
				if(num1<0||num2<0){
					System.out.println("El o los numeros introducidos son negativos, por favor reintentelo de nuevo con otros numeros.");
				}
				else {
					if(num1<num2) {
						if((num2/num1)%2==0) {
						...
						else {							System.out.println("El numero "+num2+" no es multiplo del numero "+num1);
						}
					}
					if(num1>num2) {
						if((num1/num2)%2==0) {
		        ...
		        System.out.println("El o los numeros introducidos son nulos, por favor reintentelo de nuevo con otros numeros.");
		   }
